...
export const metadata: Metadata = {
  title: "Sign Up",
  description:
    "Sign up for PR  Inspector. Start automating your GitHub pull request reviews today.",
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
        ...
        <Link
          href="/signin"
          className="font-semibold text-[#1e3a5f] hover:text-[#2a4f7a] transition-colors"
        >
          Sign in
        </Link>
      </p>
