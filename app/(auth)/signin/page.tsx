  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#c5a44e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-label="pr Inspector police cap logo" role="img" id="pr-inspector-logo">
      ...
      <form id="signin-form" className="space-y-4" aria-label="Sign in with email and password" noValidate>
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link href="/forgot-password" id="forgot-password-link" className="text-xs text-[#1e3a5f] hover:text-[#2a4f7a] dark:text-slate-400 transition-colors">Forgot password?</Link>
          </div>
      ...
      <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
        New to pr Inspector?{" "}
        <Link href="/signup" id="goto-signup-link" className="font-semibold text-[#1e3a5f] hover:text-[#2a4f7a] dark:text-slate-400 transition-colors">
          Get started free
        </Link>
      </p>
    </div>
